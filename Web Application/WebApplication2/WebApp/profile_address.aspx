<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="profile_address.aspx.cs" Inherits="WebApp.profile_address" %>
    ...
    <main>
        ...
        <div class="tabs">
            ...
            <div class="tab-links">
                ...
                <a href="profile_address.aspx" class="tab-link active address-tab">
                    <div class="icon">
                        <img src="icons/profile icons/Map pin.svg" alt="">
                    </div>
                    <p class="tab-name">Address</p>
                </a>
                <a href="profile_payment.aspx" class="tab-link payment-tab">
                    <div class="icon">
        ...
        <div class="profile-details">
            ...
            <div class="button">
                <button class="save-btn">Confirm Address</button>
            </div>
        </div>
    </main>
