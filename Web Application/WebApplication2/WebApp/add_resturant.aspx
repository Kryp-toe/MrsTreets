<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage.Master" AutoEventWireup="true" CodeBehind="add_resturant.aspx.cs" Inherits="WebApp.add_resturant" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content">
        <div class="form-content">
            <div class="form">
                <h2 class="form-name">Add a Restaurant</h2>
                <div>
                    ...
                    <asp:Button ID="addRest" runat="server" Text="Add Resturant" OnClick="addRest_Click"/>
                </div>
            </div>
        </div>
    </div>
